    ...
    <div className='fixed'>
      <div className='flex justify-between items-center h-[10vh] w-[100vw] shadow-md bg-[#F0F8FF] fixed'>
          ...
          <div className='text-3xl flex justify-center items-center ml-[10px]'>
            <FontAwesomeIcon icon={faBars} style={{cursor: 'pointer', marginLeft: "10px", color: "#5A4AE3"}}   onClick={() => dispatch(isactiveMenu())}  />
            <img src={WFW2} width="150px" className='ml-[20px] mt-[0px] flex justify-center items-center'></img>
          </div>
          {/* Right side */}
      ...
      <div className={ isActive_ ? "sideMenuWrapper visible" : "sideMenuWrapper invisible"}>
        <SideMenu />
      </div>
    </div>
  )
